...
So... obviously I had to investigate further. Essentially, the admin had some files and scripts in their home directory that other users on the server would occasionally access, and that was supposedly the reason for this setup.

Anyways one important thing stuck out to me. Pretend the below photo is from the actual machine:

{:refdef: style="text-align: center;"}
![I use arch btw](/assets/2022/01/07/openbash.png)
{: refdef}

*E-zed-pee-zed*, right? **WRONG!** 
...
A fun fact about detection logic... they're typically written by human beings, and human beings make mistakes.
